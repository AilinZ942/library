...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="book in orwell.famousWorks" :key="book">
          {{ book.title }}
        </li>
      </ul>
    </section>
    ...
    <section class="lab-section">
      ...
      <p>We operate in:</p>
      <ul>
        <li v-for="(opening, day) in bookstores.openingHours" :key="day">
          {{ day }}
          <ul>
            <li v-for="(time, status) in opening" :key="status">{{ status }}: {{ time }}</li>
          </ul>
        </li>
      </ul>
      ...
      <p>Our #1 seller:</p>
      <ul>
        <li v-for="name in bookstores.topSellers" :key="name">
          {{ name }}
        </li>
      </ul>
    </section>
